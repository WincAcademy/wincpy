...
def run(sm):
    ...
    result.append((requirement,
                   ...
                   sm.force(10, 'pluto') == 6
                   and
                   sm.force(10, 'saturn') == 104
                   and
                   sm.force(10, 'earth') == 98))
