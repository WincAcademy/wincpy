...
def run(student_module):
    ...
    result.append((requirement, player.introduce() == 'Hello everyone, my name is Super Bob.'))
    ...
    result.append((requirement,
                   ...
                   and commentator.compare_players(dirk, eric, 'speed') == 'These two players might as well be twins!'
                   ))
